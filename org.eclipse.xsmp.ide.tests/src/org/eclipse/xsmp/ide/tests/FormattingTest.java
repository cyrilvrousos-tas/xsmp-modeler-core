...
public class FormattingTest extends AbstractXsmpcatLanguageServerTest
{
  @Test
  public void testFormatting_1()
  {
  ...
  @Test
  @Disabled
  // TODO remove useless space between description and namespace in Xsmpcat formatting
  public void testFormatting_2()
  {
    testFormatting((FormattingConfiguration it) -> {
      final var model = """
              catalogue TestCatalogue
